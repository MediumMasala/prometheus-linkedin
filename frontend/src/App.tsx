...
import { TalAds } from './components/TalAds';
    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className="flex-1 flex flex-col min-h-screen">
        ...
        <main className="flex-1 p-6 overflow-auto">
          ...
          {/* Tal Character Marketing - Coming Soon */}
          {activeSidebarTab === 'tal-character-marketing' && (
            <div className="flex items-center justify-center h-full">
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold text-gray-700 mb-2">Tal Character Marketing</h3>
                <p className="text-gray-500">Video pipeline coming soon...</p>
              </div>
            </div>
          )}
